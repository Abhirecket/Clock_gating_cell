...
HD_PWD='C:/Users/Abhik/Documents/my_vivado_project/cgc/cgc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cgc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cgc.tcl
